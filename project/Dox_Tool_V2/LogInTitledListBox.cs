...
namespace Dox_Tool_V2
{
	public class LogInTitledListBox : Control
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			checked
			{
				ListB.Size = new Size(base.Width - 6, base.Height - 30);
				...
				graphics2.DrawLine(new Pen(_BorderColour, 2f), new Point(0, 27), new Point(base.Width - 1, 27));
				graphics2.DrawString(Text, _TitleFont, new SolidBrush(_TextColour), new Rectangle(2, 5, base.Width - 5, 20), new StringFormat
				{
