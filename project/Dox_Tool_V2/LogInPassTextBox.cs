...
namespace Dox_Tool_V2
{
	...
	public class LogInPassTextBox : Control
	{
		...
		protected override void OnPaint(PaintEventArgs e)
		{
			...
			checked
			{
				graphics2.FillPie(new SolidBrush(FindForm().BackColor), new Rectangle(base.Width - 25, base.Height - 60, base.Height + 25, base.Height + 25), 90f, 90f);
				...
				graphics2.FillEllipse(new SolidBrush(_TextColour), new Rectangle(10, 5, 10, 7));
